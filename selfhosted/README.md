# pass-cli-local v0.3.1

Thin Proton-style companion CLI for the local `passd` authority/capability broker. It does not contain Proton vault cryptography and does not emulate or bypass Proton's production cloud API.
...
`vault`, `item`, `resolve`, legacy `access request pass://...`, and `broker-http` remain for migration/admin compatibility. New automated workflows should use typed capabilities.
